  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto px-6 pt-24 pb-16 text-center">
        ...
        <h1 className="text-4xl sm:text-6xl font-extrabold text-gray-900 leading-tight tracking-tight mb-5">
      ...
      <div className="border-y border-gray-100 py-4 overflow-hidden mb-20">
        <div className="flex gap-3 animate-[marquee_25s_linear_infinite] whitespace-nowrap">
          {[...SKILLS,...SKILLS].map((s,i) => (
            <span key={i} className="px-4 py-1.5 bg-gray-50 border border-gray-200 rounded-full text-gray-500 text-sm flex-shrink-0">{s}</span>
          ))}
        </div>
