  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--bg)' }}>
      ...
      <div className="max-w-3xl mx-auto px-6 pt-24 pb-16 text-center">
        <div className="inline-flex items-center gap-2 border border-orange-100 text-blue-600 text-xs font-semibold px-3 py-1.5 rounded-full mb-6" style={{ background: 'var(--bg)' }}>
        ...
        <div className="grid sm:grid-cols-3 gap-5">
          {[
            ...
            <div key={s.n} className="card p-6">
              <div className="w-8 h-8 rounded-full bg-blue-500 text-white text-sm font-bold flex items-center justify-center mb-4">{s.n}</div>
